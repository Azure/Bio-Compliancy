...
| 146412e9-005c-472b-9e48-c87b72ac229e | A Microsoft Entra administrator should be provisioned for MySQL servers | U.07.3 - Beheerfuncties,U.10.2 - Beheerders,U.10.5 - Toegangsbeperking,U.10.3 - Gebruik van geauthenticeerde apparatuur |  |
...
| 40e85574-ef33-47e8-a854-7a65c7500560 | Azure MySQL flexible server should have Microsoft Entra Only Authentication enabled | U.10.5 - Toegangsbeperking,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.2 - Beheerders |  |
...
| 640d2586-54d2-465f-877f-9ffc1d2109f4 | Microsoft Defender for Storage should be enabled | C.04.6 - Patchmanagement,C.04.7 - Evaluatie,C.04.8 - Evaluatie,C.04.3 - Tijdslijnen |  |
...
| 72650e9f-97bc-4b2a-ab5f-9781a9fcecbc | Windows machines should meet requirements of the Azure compute security baseline | C.04.7 - Evaluatie,U.15.1 - Registratie,U.15.3 - Registratie |  |
...
| 938c4981-c2c9-4168-9cd6-972b8675f906 | Microsoft Defender for SQL status should be protected for Arc-enabled SQL Servers | C.04.3 - Tijdslijnen,C.04.8 - Evaluatie,C.04.7 - Evaluatie,C.04.6 - Patchmanagement |  |
...
| c6283572-73bb-4deb-bf2c-7a2b8f7462cb | SQL server-targeted autoprovisioning should be enabled for SQL servers on machines plan | C.04.8 - Evaluatie,C.04.7 - Evaluatie |  |
...
| fc9b3da7-8347-4380-8e70-0a0361d8dedd | Linux machines should meet requirements for the Azure compute security baseline | U.15.3 - Registratie,C.04.7 - Evaluatie,U.15.1 - Registratie |  |
...
| PolicyName|policyDisplayName|Category|Remarks |
| --- | --- | --- | --- |
| 090c7b07-b4ed-4561-ad20-e9075f3ccaff | Azure registry container images should have vulnerabilities resolved (powered by Microsoft Defender Vulnerability Management) | C.04.6 - Patchmanagement,U.09.3 - Detectie, preventie en herstel,C.04.8 - Evaluatie,C.04.7 - Evaluatie |  |
| 0c28c3fb-c244-42d5-a9bf-f35f2999577b | Azure SQL Managed Instance should have Microsoft Entra-only authentication enabled | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking |  |
| 17f4b1cc-c55c-4d94-b1f9-2978f6ac2957 | Azure running container images should have vulnerabilities resolved (powered by Microsoft Defender Vulnerability Management)2 | C.04.7 - Evaluatie,C.04.8 - Evaluatie,U.09.3 - Detectie, preventie en herstel,C.04.6 - Patchmanagement |  |
| 1afdc4b6-581a-45fb-b630-f1e6051e3e7a | Linux virtual machines should have Azure Monitor Agent installed | U.15.1 - Registratie |  |
| 2158ddbe-fefa-408e-b43f-d4faef8ff3b8 | Synapse Workspaces should use only Microsoft Entra identities for authentication during workspace creation | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking |  |
...
| bd876905-5b84-4f73-ab2d-2e7a7c4568d9 | Machines should be configured to periodically check for missing system updates | C.04.3 - Tijdslijnen,C.04.6 - Patchmanagement,C.04.7 - Evaluatie,U.09.3 - Detectie, preventie en herstel |  |
...
| 32133ab0-ee4b-4b44-98d6-042180979d50 | [Preview]: Log Analytics Extension should be enabled for listed virtual machine images | The MMA agent is replaced by AMA Agent |
| 5c3bc7b8-a64c-4e08-a9cd-7ff0f31e1138 | Log Analytics extension should be enabled in virtual machine scale sets for listed virtual machine images | The MMA agent is replaced by AMA Agent |
| a4fe33eb-e377-4efb-ab31-0784311bc499 | Log Analytics agent should be installed on your virtual machine for Azure Security Center monitoring | The MMA agent is replaced by AMA Agent |
| a3a6ea0c-e018-4933-9ef0-5aaa1501449b | Log Analytics agent should be installed on your virtual machine scale sets for Azure Security Center monitoring | The MMA agent is replaced by AMA Agent |
| d69b1763-b96d-40b8-a2d9-ca31e9fd0d3e | [Preview]: Log Analytics extension should be installed on your Windows Azure Arc machines | The MMA agent is replaced by AMA Agent |
| 842c54e8-c2f9-4d79-ae8d-38d8b8019373 | [Preview]: Log Analytics extension should be installed on your Linux Azure Arc machines | The MMA agent is replaced by AMA Agent |
| 475aae12-b88a-4572-8b36-9b712b2b3a17 | Auto provisioning of the Log Analytics agent should be enabled on your subscription | The MMA agent is replaced by AMA Agent |
...
| 21a6bc25-125e-4d13-b82d-2e19b7208ab7 | VPN gateways should use only Azure Active Directory (Azure AD) authentication for point-to-site users | U.07.3 - Beheerfuncties,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.10.2 - Beheerders |  |
...
| 8c6a50c6-9ffd-4ae7-986f-5fa6111f9a54 | Storage accounts should prevent shared key access | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.10.2 - Beheerders,U.07.3 - Beheerfuncties |  |
...
| 0cfea604-3201-4e14-88fc-fae4c427a6c5 | Blocked accounts with owner permissions on Azure resources should be removed | U.07.3 - Beheerfuncties,U.10.5 - Toegangsbeperking,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.2 - Beheerders |  |
...
| 339353f6-2387-4a45-abe4-7f529d121046 | Guest accounts with owner permissions on Azure resources should be removed | U.07.3 - Beheerfuncties,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.2 - Beheerders,U.10.5 - Toegangsbeperking |  |
