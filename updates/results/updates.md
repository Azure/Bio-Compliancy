...
| 5bb220d9-2698-4ee4-8404-b9c30c9df609 | App Service apps should have 'Client Certificates (Incoming client certificates)' enabled | U.10.3 - Gebruik van geauthenticeerde apparatuur |
...
| 6ba6d016-e7c3-4842-b8f2-4992ebc0d72d | SQL servers on machines should have vulnerability findings resolved | U.09.3 - Detectie, preventie en herstel,C.04.8 - Evaluatie,C.04.7 - Evaluatie,C.04.6 - Patchmanagement,C.04.3 - Tijdslijnen |
...
| 8d7e1fde-fe26-4b5f-8108-f8e432cbc2be | Blocked accounts with read and write permissions on Azure resources should be removed | U.10.2 - Beheerders,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.07.3 - Beheerfuncties |
| 91a78b24-f231-4a8a-8da9-02c35b2b6510 | Audit virtual machines without disaster recovery configured | U.15.1 - Registratie |
...
| ac4a19c2-fa67-49b4-8ae5-0b2e78c49457 | Role-Based Access Control (RBAC) should be used on Kubernetes Services | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.07.3 - Beheerfuncties,U.10.2 - Beheerders,U.10.5 - Toegangsbeperking |
...
| e3e008c3-56b9-4133-8fd7-d3347377402a | Accounts with owner permissions on Azure resources should be MFA enabled | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.10.2 - Beheerders |
| e8cbc669-f12d-49eb-93e7-9273119e9933 | Vulnerabilities in container security configurations should be remediated | C.04.3 - Tijdslijnen,C.04.6 - Patchmanagement,C.04.7 - Evaluatie,C.04.8 - Evaluatie,U.09.3 - Detectie, preventie en herstel |
...
| eaebaea7-8013-4ceb-9d14-7eb32271373c | Function apps should have 'Client Certificates (Incoming client certificates)' enabled | U.10.3 - Gebruik van geauthenticeerde apparatuur |
...
| --- | --- |
| cc9835f2-9f6b-4cc8-ab4a-f8ef615eb349 | [Deprecated]: Sensitive data in your SQL databases should be classified |
| c4d441f8-f9d9-4a9e-9cef-e82117cb3eef | [Deprecated]: Managed identity should be used in your API App |
| 5f76cf89-fbf2-47fd-a3f4-b891fa780b60 | [Deprecated]: External accounts with read permissions should be removed from your subscription |
| 5c607a2e-c700-4744-8254-d77e7c9eb5e4 | [Deprecated]: External accounts with write permissions should be removed from your subscription |
| f8456c1c-aa66-4dfb-861a-25d127b775c9 | [Deprecated]: External accounts with owner permissions should be removed from your subscription |
| 6b1cbf55-e8b6-442f-ba4c-7246b6381474 | [Deprecated]: Deprecated accounts should be removed from your subscription |
| e3576e28-8b17-4677-84c3-db2990658d64 | [Deprecated]: MFA should be enabled on accounts with read permissions on your subscription |
| 9297c21d-2ed6-4474-b48f-163f75654ce3 | [Deprecated]: MFA should be enabled for accounts with write permissions on your subscription |
| ebb62a0c-3560-49e1-89ed-27e074e9f8ad | [Deprecated]: Deprecated accounts with owner permissions should be removed from your subscription |
| aa633080-8b72-40c4-a2d7-d00c03e80bed | [Deprecated]: MFA should be enabled on accounts with owner permissions on your subscription |
| 5f0bc445-3935-4915-9981-011aa2b46147 | [Deprecated]: Private endpoint should be configured for Key Vault |
| 991310cd-e9f3-47bc-b7b6-f57b557d07db | [Deprecated]: Ensure that 'HTTP Version' is the latest, if used to run the API app |
| 88999f4c-376a-45c8-bcb3-4058f713cf39 | [Deprecated]: Ensure that 'Java version' is the latest, if used as a part of the API app |
| 74c3584d-afae-46f7-a20a-6f8adba71a16 | [Deprecated]: API apps that use Python should use the latest 'Python version' |
| 1bc1795e-d44a-4d48-9b3b-6fff0fd5f9ba | [Deprecated]: Ensure that 'PHP version' is the latest, if used as a part of the API app |
| 9a1b8c48-453a-4044-86c3-d8bfd823e4f5 | [Deprecated]: FTPS only should be required in your API App |
| b7ddfbdc-1260-477d-91fd-98bd9be789a6 | [Deprecated]: API App should only be accessible over HTTPS |
| 8cb6aa8b-9e41-4f4e-aa25-089a7ac2581e | [Deprecated]: Latest TLS version should be used in your API App |
| 52630df9-ca7e-442b-853b-c6ce548b31a2 | [Deprecated]: Azure Web PubSub Service should use private link |
| 40cec1dd-a100-4920-b15b-3024fe8901ab | [Deprecated]: Azure Machine Learning workspaces should use private link |
| 53503636-bcc9-4748-9663-5348217f160f | [Deprecated]: Azure SignalR Service should use private link |
| b607c5de-e7d9-4eee-9e5c-83f1bcee4fa0 | [Deprecated]: Diagnostic logs in App Services should be enabled |
| 7c1b1214-f927-48bf-8882-84f0af6588b1 | [Deprecated]: Resource logs in Virtual Machine Scale Sets should be enabled |
