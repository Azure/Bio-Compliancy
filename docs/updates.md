...
| --- | --- | --- | --- |
| 090c7b07-b4ed-4561-ad20-e9075f3ccaff | Azure registry container images should have vulnerabilities resolved (powered by Microsoft Defender Vulnerability Management) | U.09.3 - Detectie, preventie en herstel,C.04.8 - Evaluatie,C.04.6 - Patchmanagement,C.04.7 - Evaluatie |  |
...
| bd876905-5b84-4f73-ab2d-2e7a7c4568d9 | Machines should be configured to periodically check for missing system updates | U.09.3 - Detectie, preventie en herstel,C.04.3 - Tijdslijnen,C.04.6 - Patchmanagement,C.04.7 - Evaluatie |  |
...
| ae89ebca-1c92-4898-ac2c-9f63decb045c | Guest Configuration extension should be installed on your machines | Because of single agent (MDE) feuture not mandotory. See link https://learn.microsoft.com/en-us/azure/defender-for-cloud/upcoming-changes#deprecation-of-mma-related-recommendations |
...
| 21a6bc25-125e-4d13-b82d-2e19b7208ab7 | VPN gateways should use only Azure Active Directory (Azure AD) authentication for point-to-site users | U.07.3 - Beheerfuncties,U.10.2 - Beheerders,U.10.5 - Toegangsbeperking,U.10.3 - Gebruik van geauthenticeerde apparatuur |  |
...
| 8c6a50c6-9ffd-4ae7-986f-5fa6111f9a54 | Storage accounts should prevent shared key access | U.10.2 - Beheerders,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.07.3 - Beheerfuncties,U.10.5 - Toegangsbeperking |  |
...
| 0cfea604-3201-4e14-88fc-fae4c427a6c5 | Blocked accounts with owner permissions on Azure resources should be removed | U.10.2 - Beheerders,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.07.3 - Beheerfuncties |  |
...
| 339353f6-2387-4a45-abe4-7f529d121046 | Guest accounts with owner permissions on Azure resources should be removed | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.10.2 - Beheerders,U.07.3 - Beheerfuncties |  |
...
| 8d7e1fde-fe26-4b5f-8108-f8e432cbc2be | Blocked accounts with read and write permissions on Azure resources should be removed | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.2 - Beheerders,U.10.5 - Toegangsbeperking,U.07.3 - Beheerfuncties |  |
| 91a78b24-f231-4a8a-8da9-02c35b2b6510 | App Service apps should have resource logs enabled | U.15.1 - Registratie |  |
| 931e118d-50a1-4457-a5e4-78550e086c52 | Accounts with write permissions on Azure resources should be MFA enabled | U.10.2 - Beheerders,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.11.1 - Beleid,U.11.2 - Cryptografische maatregelen |  |
...
| e96a9a5f-07ca-471b-9bc5-6a0f33cbd68f | Azure Machine Learning Computes should have local authentication methods disabled | U.10.2 - Beheerders,U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking |  |
| e9ac8f8e-ce22-4355-8f04-99b911d6be52 | Guest accounts with read permissions on Azure resources should be removed | U.10.3 - Gebruik van geauthenticeerde apparatuur,U.10.5 - Toegangsbeperking,U.10.2 - Beheerders,U.07.3 - Beheerfuncties |  |
...
| f655e522-adff-494d-95c2-52d4f6d56a42 | [Preview]: Guest Attestation extension should be installed on supported Windows virtual machines scale sets | U.05.2 - Cryptografische maatregelen,U.11.3 - Versleuteld |  |
